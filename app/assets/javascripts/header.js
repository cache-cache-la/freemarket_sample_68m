$(function(){
  var categoryList = $(".list__category");
  var categoryListTrig = $(".list__category > a");
  var parentList = $(".parent__tree");
  var parentListTrig = $(".parent__tree > li");
  var childList = $(".children__tree");
  var childListTrig = $(".children__tree > li");

  categoryListTrig.hover(function(){
    $(this).children('.parent__tree').stop().show('fast');
  }, function() {
    $(this).children('.parent__tree').stop().hide('fast');
  });
  parentListTrig.hover(function(){
    $(this).children('.children__tree').stop().show('fast');
  }, function() {
    $(this).children('.children__tree').stop().hide('fast');
  });
  childListTrig.hover(function(){
    $(this).children('.grandchildren__tree').stop().show('fast');
  }, function() {
    $(this).children('.grandchildren__tree').stop().hide('fast');
  });
});
