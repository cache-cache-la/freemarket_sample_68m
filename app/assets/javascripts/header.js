$(function(){
  ...
  var categoryListTrig = $(".list__category > li");
  var parentList = $(".parent__tree");
  var parentListTrig = $(".parent__tree > li");
  var childList = $(".child__tree");
  var childListTrig = $(".child__tree > li");

  categoryListTrig.hover(function(){
    $(this).children('.parent').show('fast');
  }, function() {
    $(this).children('.parent').hide('fast');
  });
  parentListTrig.hover(function(){
    $(this).children('.child').show('fast');
  }, function() {
    $(this).children('.child').hide('fast');
  });
