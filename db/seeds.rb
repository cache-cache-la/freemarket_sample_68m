...
Address.create(postal_code: 111-1111, prefecture:13, municipality:"渋谷区道玄坂", number:"1-1-1", building:"ビル４階", user_id:3)
# Card.create(user_id:3, customer_id:"cus_52b54d53010df500a1854e1ca1ec", card_id:"car_04f185dc95767e08a6edcafbd3ee")
Item.create(name: "あああ", text: "テストtestテスト", price: 15000)
Image.create(picture: "/animal1.png")